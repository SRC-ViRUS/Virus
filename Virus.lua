...
if not DevSOFI:get(Server.."IdVirus") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local ViRUS = io.read():gsub(' ','') 
if tostring(ViRUS):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevSOFI:set(Server.."IdVirus",ViRUS) 
else 
print('\27[1;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉') 
end
os.execute('lua Virus.lua') 
end 
if not DevSOFI:get(Server.."TokenVirus") then 
...
DevSOFI:set(Server.."TokenVirus",TokenBot) 
end  
else 
...
Config = {
ViRUS = DevSOFI:get(Server.."IdVirus"),
TokenBot = DevSOFI:get(Server.."TokenVirus"),
Virus = DevSOFI:get(Server.."TokenVirus"):match("(%d+)"),
SudoIds = {DevSOFI:get(Server.."IdVirus")},
}
...
#!/usr/bin/env bash
cd $HOME/Virus
token="]]..DevSOFI:get(Server.."TokenVirus")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
f:close() 
DevSOFI:del(Server.."IdVirus");DevSOFI:del(Server.."TokenVirus")
end 
...
ViRUS = Config.ViRUS
SudoIds = {Config.SudoIds,1925927748,119541395}
Virus = Config.Virus
TokenBot = Config.TokenBot
NameBot = (DevSOFI:get(Virus..'SOFI:NameBot') or 'فايروس')
--     Source Virus     --
...
if user_id == tonumber(ViRUS) then 
var = true 
end 
return var 
end
...
local Status = DevSOFI:sismember(Virus..'SOFI:SOFISudo:',msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:SudoBot:',msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:SOFIConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SOFISudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevSOFI:sismember(Virus..'SOFI:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevSOFI:sismember(Virus..'SOFI:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevSOFI:sismember(Virus..'SOFI:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevSOFI:sismember(Virus..'SOFI:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or SOFIConstructor(msg) or SOFISudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevSOFI:sismember(Virus..'SOFI:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevSOFI:sismember(Virus..'SOFI:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevSOFI:sismember(Virus..'SOFI:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevSOFI:sismember(Virus..'SOFI:MuteAll:', user_id) then
var = true
else
var = false
end
...
vardump(JsonInfo)
DevSOFI:set(Virus.."SOFI:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevSOFI:sadd(Virus.."SOFI:Groups",IdGps) 
DevSOFI:set(Virus.."SOFI:Lock:Bots"..IdGps,"del") DevSOFI:hset(Virus.."SOFI:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevSOFI:set(Virus..Lock..IdGps,true)
end
if v.SOFIConstructors then
for k,IdSOFIConstructors in pairs(v.SOFIConstructors) do
DevSOFI:sadd(Virus..'SOFI:SOFIConstructor:'..IdGps,IdSOFIConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevSOFI:sadd(Virus..'SOFI:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevSOFI:sadd(Virus..'SOFI:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevSOFI:sadd(Virus..'SOFI:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevSOFI:sadd(Virus..'SOFI:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevSOFI:sadd(Virus..'SOFI:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevSOFI:set(Virus.."SOFI:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevSOFI:set(Virus.."SOFI:Groups:Welcomes"..IdGps,v.Welcomes)   
...
VirusTeam  = "المطور" elseif SOFISudo(msg) then 
VirusTeam = "المطور" elseif SecondSudo(msg) then 
VirusTeam = "المطور" elseif SudoBot(msg) then
VirusTeam = "المطور" elseif Manager(msg) then 
VirusTeam = "المدير" elseif Admin(msg) then 
VirusTeam = "الادمن" else
VirusTeam = "العضو" end 
return VirusTeam 
end
...
elseif DevSOFI:sismember(Virus..'SOFI:SOFIConstructor:'..chat_id, user_id) then
var = true
elseif DevSOFI:sismember(Virus..'SOFI:Owner:'..chat_id, user_id) then
var = true
elseif DevSOFI:sismember(Virus..'SOFI:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevSOFI:sismember(Virus..'SOFI:Constructor:'..chat_id, user_id) then
...
local SOFI = (Virus..'SOFI:Filters:'..msg.chat_id_)
if SOFI then
...
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevSOFI:get(Virus..'SOFI:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevSOFI:get(Virus..'SOFI:ChText') then
...
if DataText == '/delyes' and DevSOFI:get(Virus..'yes'..data.sender_user_id_) == 'delyes' then
...
if DevSOFI:sismember(Virus..'SOFI:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevSOFI:sismember(Virus..'SOFI:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevSOFI:sismember(Virus..'SOFI:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevSOFI:sismember(Virus..'SOFI:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevSOFI:sismember(Virus..'SOFI:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevSOFI:sismember(Virus..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevSOFI:sismember(Virus..'SOFI:Constructor:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(Virus..'SOFI:Managers:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(Virus..'SOFI:Admins:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(Virus..'SOFI:VipMem:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(Virus..'SOFI:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevSOFI:sismember(Virus..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevSOFI:srem(Virus..'SOFI:Constructor:'..data.chat_id_,data.sender_user_id_)
DevSOFI:srem(Virus..'SOFI:Managers:'..data.chat_id_,data.sender_user_id_)
DevSOFI:srem(Virus..'SOFI:Admins:'..data.chat_id_,data.sender_user_id_)
...
DevSOFI:incrby(Virus..'SOFI:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
...
if DevSOFI:sismember(Virus..'SOFI:Tkeed:'..Chat_Id2, data.sender_user_id_) then
...
if text and DevSOFI:get(Virus.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevSOFI:get(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
...
if text and text:match('^'..(DevSOFI:get(Virus..'SOFI:NameBot') or "فايروس")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevSOFI:get(Virus..'SOFI:NameBot') or "فايروس")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevSOFI:get(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
...
if text and DevSOFI:get(Virus.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
...
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevSOFI:sadd(Virus.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevSOFI:set(Virus.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
...
if DevSOFI:sismember(Virus.."Coomds"..msg.chat_id_,DEV_SOFI) then
...
if DevSOFI:sismember(Virus.."Coomds"..msg.chat_id_,text1[2]) then
...
DevSOFI:incr(Virus..'SOFI:UsersMsgs'..Virus..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevSOFI:incr(Virus..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevSOFI:incr(Virus..'SOFI:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevSOFI:sismember(Virus.."SOFI:Users",msg.chat_id_) then
DevSOFI:sadd(Virus.."SOFI:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
DevSOFI:setex(Virus..'SOFI:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source Virus     --
...
DevSOFI:incr(Virus..'SOFI:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevSOFI:set(Virus.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevSOFI:get(Virus.."SOFI:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevSOFI:sadd(Virus..'SOFI:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevSOFI:incr(Virus..'SOFI:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevSOFI:incr(Virus..'SOFI:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     
Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevSOFI:get(Virus.."SOFI:Add:AllRed"..msg.sender_user_id_)
...
DevSOFI:del(Virus.."SOFI:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevSOFI:get(Virus.."SOFI:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevSOFI:set(Virus.."SOFI:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevSOFI:set(Virus.."SOFI:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevSOFI:set(Virus.."SOFI:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevSOFI:set(Virus.."SOFI:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevSOFI:set(Virus.."SOFI:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevSOFI:set(Virus.."SOFI:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevSOFI:set(Virus.."SOFI:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
...
if msg.content_.text_ and not DevSOFI:get(Virus..'SOFI:Lock:AllRed'..msg.chat_id_) then
if DevSOFI:get(Virus.."SOFI:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(Virus.."SOFI:Video:AllRed"..msg.content_.text_))
end
if DevSOFI:get(Virus.."SOFI:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(Virus.."SOFI:File:AllRed"..msg.content_.text_))
end
if DevSOFI:get(Virus.."SOFI:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(Virus.."SOFI:Voice:AllRed"..msg.content_.text_))
end
if DevSOFI:get(Virus.."SOFI:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(Virus.."SOFI:Audio:AllRed"..msg.content_.text_))
end
if DevSOFI:get(Virus.."SOFI:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(Virus.."SOFI:Photo:AllRed"..msg.content_.text_))
end
if  DevSOFI:get(Virus.."SOFI:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevSOFI:get(Virus.."SOFI:Gif:AllRed"..msg.content_.text_))
end
if DevSOFI:get(Virus.."SOFI:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevSOFI:get(Virus.."SOFI:Stecker:AllRed"..msg.content_.text_))
end
if DevSOFI:get(Virus.."SOFI:Text:AllRed"..msg.content_.text_) then
function VirusTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevSOFI:get(Virus..'SOFI:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevSOFI:get(Virus..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevSOFI:get(Virus.."SOFI:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevSOFI:sismember(Virus..'SOFI:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevSOFI:sismember(Virus..'SOFI:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevSOFI:sadd(Virus..'SOFI:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source Virus     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= Virus then
floods = DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevSOFI:get(Virus.."SOFI:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevSOFI:setex(Virus.."SOFI:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source Virus     --
...
DevSOFI:set(Virus..'SOFI:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevSOFI:get(Virus..'SOFI:PinnedMsg'..msg.chat_id_)
if pin_id and DevSOFI:get(Virus..'SOFI:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevSOFI:get(Virus..'SOFI:viewget'..msg.sender_user_id_) then
...
if DevSOFI:get(Virus..'SOFI:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevSOFI:get(Virus..'SOFI:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if not DevSOFI:get(Virus..'SOFI:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Virus,offset_ = 0,limit_ = 1},function(extra,SOFI,success) 
...
if not DevSOFI:get(Virus..'SOFI:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevSOFI:get(Virus..'SOFI:Spam:Text'..msg.chat_id_))
end
if DevSOFI:get(Virus..'SOFI:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
for k,v in pairs(List) do 
LinkGroups = DevSOFI:get(Virus.."SOFI:Groups:Links"..v)
Welcomes = DevSOFI:get(Virus..'SOFI:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
SOFIConstructors = DevSOFI:smembers(Virus..'SOFI:SOFIConstructor:'..v)
Constructors = DevSOFI:smembers(Virus..'SOFI:BasicConstructor:'..v)
BasicConstructors = DevSOFI:smembers(Virus..'SOFI:Constructor:'..v)
Managers = DevSOFI:smembers(Virus..'SOFI:Managers:'..v)
Admis = DevSOFI:smembers(Virus..'SOFI:Admins:'..v)
Vips = DevSOFI:smembers(Virus..'SOFI:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
--     Source Virus     --
if DevSOFI:get(Virus.."SET:GAME"..msg.chat_id_) then  
...
--     Source Virus     --
if text == "الرابط" then
if not DevSOFI:get(Virus.."SOFI:Lock:GpLinksinline"..msg.chat_id_) then 
...
NameBot = (DevSOFI:get(Virus..'SOFI:NameBot') or 'فايروس')
local VirusTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevSOFI2 = math.random(#VirusTeam) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, VirusTeam[DevSOFI2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevSOFI:get(Virus..'SOFI:NameBot') or 'فايروس') 
local VirusTeam = {"اسمي القميل "..NameBot.." "} 
DevSOFI2 = math.random(#VirusTeam) 
Dev_SOFI(msg.chat_id_, msg.id_, 1, VirusTeam[DevSOFI2] , 1, 'html') 
return false
end
if text and text == (DevSOFI:get(Virus..'SOFI:NameBot') or 'فايروس') then 
NameBot = (DevSOFI:get(Virus..'SOFI:NameBot') or 'فايروس')
...
DevSOFI:set(Virus..'SOFI:GameNum'..msg.chat_id_,name)
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(Virus..'SOFI:GameNum2'..msg.chat_id_,name)
DevSOFI:del(Virus..'SOFI:Games:Ids'..msg.chat_id_)
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(Virus..'SOFI:GameNum3'..msg.chat_id_,name)
DevSOFI:del(Virus..'SOFI:Games:Ids'..msg.chat_id_)
...
DevSOFI2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(Virus..'SOFI:GameNum4'..msg.chat_id_,name)
DevSOFI:del(Virus..'SOFI:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(Virus..'SOFI:GameNum5'..msg.chat_id_,name)
DevSOFI:del(Virus..'SOFI:Games:Ids'..msg.chat_id_)
...
if text == DevSOFI:get(Virus..'SOFI:GameNum5'..msg.chat_id_) then
if not DevSOFI:get(Virus..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(Virus..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(Virus..'SOFI:GameNum6'..msg.chat_id_,name)
DevSOFI:del(Virus..'SOFI:Games:Ids'..msg.chat_id_)
...
if text == DevSOFI:get(Virus..'SOFI:GameNum6'..msg.chat_id_) then
if not DevSOFI:get(Virus..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(Virus..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
...
name = DevSOFI2[math.random(#DevSOFI2)]
DevSOFI:set(Virus..'SOFI:GameNum7'..msg.chat_id_,name)
DevSOFI:del(Virus..'SOFI:Games:Ids'..msg.chat_id_)
...
if text == DevSOFI:get(Virus..'SOFI:GameNum7'..msg.chat_id_) then
if not DevSOFI:get(Virus..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(Virus..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
...
if text == DevSOFI:get(Virus..'SOFI:GameNum8'..msg.chat_id_) then
if not DevSOFI:get(Virus..'SOFI:Games:Ids'..msg.chat_id_) then 
DevSOFI:incrby(Virus..'SOFI:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
...
--     Source Virus     --
if DevSOFI:get(Virus.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
...
local CountAdd = DevSOFI:get(Virus.."SOFI:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevSOFI:scard(Virus..'SOFI:ListRolet'..msg.chat_id_)
...
DevSOFI:sadd(Virus..'SOFI:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevSOFI:sadd(Virus..'SOFI:SOFIConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
local msguser = tonumber(DevSOFI:get(Virus..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevSOFI:get(Virus..'SOFI:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevSOFI:get(Virus..'SOFI:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
local PvList = DevSOFI:smembers(Virus.."SOFI:Users")
...
i = i + 1
if DevSOFI:get(Virus..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevSOFI:get(Virus..'Save:UserName'..v.user_id_).."]\n"
else
...
--     Source Virus     --
if (text and not DevSOFI:get(Virus.."SOFI:Lock:AutoFile")) then
Time = DevSOFI:get(Virus.."SOFI:AutoFile:Time")
if Time then 
...
Welcomes = DevSOFI:get(Virus..'SOFI:Groups:Welcomes'..v) or ''
SOFIConstructors = DevSOFI:smembers(Virus..'SOFI:SOFIConstructor:'..v)
BasicConstructors = DevSOFI:smembers(Virus..'SOFI:BasicConstructor:'..v)
Constructors = DevSOFI:smembers(Virus..'SOFI:Constructor:'..v)
Managers = DevSOFI:smembers(Virus..'SOFI:Managers:'..v)
Admis = DevSOFI:smembers(Virus..'SOFI:Admins:'..v)
Vips = DevSOFI:smembers(Virus..'SOFI:VipMem:'..v)
if k == 1 then
...
if DevSOFI:get(Virus.."SOFI:msg:SOFI"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevSOFI:get(Virus.."SOFI:msg:SOFI"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevSOFI:setex(Virus..'SOFI:msg:SOFI'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
if tonumber(result.id_) == tonumber(1925927748) then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
if DevSOFI:sismember(Virus.."SOFI:SOFIConstructor:"..msg.chat_id_,result.id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if tonumber(result.sender_user_id_) == tonumber(1925927748) then  
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if DevSOFI:sismember(Virus.."SOFI:SOFIConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_SOFI(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local VirusTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
Dev_SOFI(msg.chat_id_, result.id_, 1,''..VirusTeam[math.random(#VirusTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
if DevSOFI:sismember(Virus..'SOFI:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevSOFI:sismember(Virus..'SOFI:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevSOFI:sismember(Virus..'SOFI:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevSOFI:sismember(Virus..'SOFI:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevSOFI:sismember(Virus..'SOFI:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevSOFI:sismember(Virus..'SOFI:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevSOFI:sismember(Virus..'SOFI:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevSOFI:sismember(Virus..'SOFI:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
SOFIsudo = 'المطورين الاساسيين • ' else SOFIsudo = '' end
if DevSOFI:sismember(Virus..'SOFI:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if D
ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
newpicid = DevSOFI:get(Virus.."SOFI:AllIds:Text")
...
local new_id = DevSOFI:get(Virus.."SOFI:GpIds:Text"..msg.chat_id_)
...
if DevSOFI:get(Virus.."SOFI:AllIds:Text") then
newallid = DevSOFI:get(Virus.."SOFI:AllIds:Text")
...
if DevSOFI:get(Virus.."SOFI:AllIds:Text") then
notpicid = DevSOFI:get(Virus.."SOFI:AllIds:Text")
...
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevSOFI:get(Virus.."SOFI:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevSOFI:set(Virus.."SOFI:Groups:Links"..msg.chat_id_,LinkGroup) 
...
local Welcomes = DevSOFI:get(Virus..'SOFI:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_SOFI(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
DevSOFI:srem(Virus.."SOFI:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
DevSOFI:srem(Virus.."SOFI:Groups",group[i]) 
...
if DevSOFI:get(Virus..'SOFI:CleanNum'..msg.chat_id_) then CleanNum = DevSOFI:get(Virus..'SOFI:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevSOFI:scard(Virus.."SOFI:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevSOFI:smembers(Virus.."SOFI:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
if DevSOFI:get(Virus..'SOFI:Lock:CleanNum'..msg.chat_id_) then 
...
if Cleaner(msg) then
if DevSOFI:get(Virus..'SOFI:Lock:Clean'..msg.chat_id_) then 
...
if DevSOFI:get(Virus..'SOFI:Lock:CleanMusic'..msg.chat_id_) then 
...
DevSOFI:del(Virus.."SOFI:Admins:Rd"..msg.chat_id_)
DevSOFI:del(Virus.."SOFI:Managers:Rd"..msg.chat_id_)
DevSOFI:del(Virus.."SOFI:Constructor:Rd"..msg.chat_id_)
DevSOFI:del(Virus.."SOFI:BasicConstructor:Rd"..msg.chat_id_)
DevSOFI:del(Virus.."SOFI:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source Virus     --
...
local Managers = DevSOFI:smembers(Virus..'SOFI:Managers:'..msg.chat_id_)
local admins = DevSOFI:smembers(Virus..'SOFI:Admins:'..msg.chat_id_)
local vipmem = DevSOFI:smembers(Virus..'SOFI:VipMem:'..msg.chat_id_)
local donky = DevSOFI:smembers(Virus..'User:Donky:'..msg.chat_id_)
...
spam_c = DevSOFI:get(Virus..'SOFI:Spam:Text'..msg.chat_id_)
end
--     Source Virus     --
if DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevSOFI:hget(Virus.."SOFI:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source Virus     --
if DevSOFI:get(Virus.."SOFI:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevSOFI:get(Virus.."SOFI:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevSOFI:get(Virus.."SOFI:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source Virus     --
if DevSOFI:get(Virus..'SOFI:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevSOFI:get(Virus..'SOFI:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevSOFI:get(Virus.."SOFI:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevSOFI:get(Virus..'SOFI:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevSOFI:get(Virus..'SOFI:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevSOFI:get(Virus..'SOFI:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
...
if text and text:match("^انطق (.*)$") and not DevSOFI:get(Virus..'SOFI:Antk:SOFI'..msg.chat_id_) and ChCheck(msg) then
...
local rules = DevSOFI:get(Virus..'SOFI:rules'..msg.chat_id_)
...
if not DevSOFI:get(Virus..'SOFI:Brg:SOFI'..msg.chat_id_) then
...
if not DevSOFI:get(Virus..'SOFI:Age:SOFI'..msg.chat_id_) then
...
if not DevSOFI:get(Virus..'SOFI:Mean:SOFI'..msg.chat_id_) then
...
--     Source Virus     --
if msg.content_.photo_ then
if DevSOFI:get(Virus..'SOFI:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
local ManagerList = DevSOFI:scard(Virus.."SOFI:Managers:"..ChatId) or 0
local MutedList = DevSOFI:scard(Virus.."SOFI:Muted:"..ChatId) or 0
local TkeedList = DevSOFI:scard(Virus.."SOFI:SOFI:Tkeed:"..ChatId) or 0
...
DevSOFI:set(Virus..'SOFI:SudosGp'..msg.sender_user_id_..msg.chat_id_,"SOFI")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
List = DevSOFI:smembers(Virus..'SOFI:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
SOFIText = "الرساله"
...
List = DevSOFI:smembers(Virus..'SOFI:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
SOFIText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
local List = DevSOFI:smembers(Virus..'SOFI:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_SOFI(msg.chat_id_, msg.id_, 1, "☭︙تم اذاعة رسالتك بالتوجيه \n☭︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
SOFIText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevSOFI:set(Virus..'SOFI:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
SOFIText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevSOFI:set(Virus..'SOFI:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
SOFIText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevSOFI:set(Virus..'SOFI:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
SOFIText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevSOFI:set(Virus..'SOFI:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
SOFIText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevSOFI:set(Virus..'SOFI:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
SOFIText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevSOFI:set(Virus..'SOFI:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
SOFIText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevSOFI:set(Virus..'SOFI:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
SOFIText = "الملصق"
...
DevSOFI:set(Virus..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source Virus     --
...
DevSOFI:set(Virus.."DelSudoRep",text)
return false 
end end
--     Source Virus     --
...
dp = 'متحركه 🎭'
elseif DevSOFI:get(Virus.."SOFI:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevSOFI:get(Virus.."SOFI:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevSOFI:get(Virus.."SOFI:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevSOFI:get(Virus.."SOFI:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevSOFI:get(Virus.."SOFI:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevSOFI:get(Virus.."SOFI:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevSOFI:get(Virus.."SOFI:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
DevSOFI:del(Virus..'SOFI:Voice:GpRed'..v..msg.chat_id_)
DevSOFI:del(Virus..'SOFI:Audio:GpRed'..v..msg.chat_id_)
DevSOFI:del(Virus..'SOFI:Photo:GpRed'..v..msg.chat_id_)
DevSOFI:del(Virus..'SOFI:Stecker:GpRed'..v..msg.chat_id_)
DevSOFI:del(Virus..'SOFI:Video:GpRed'..v..msg.chat_id_)
DevSOFI:del(Virus..'SOFI:File:GpRed'..v..msg.chat_id_)
...
dp = 'متحركه 🎭'
elseif DevSOFI:get(Virus.."SOFI:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevSOFI:get(Virus.."SOFI:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevSOFI:get(Virus.."SOFI:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevSOFI:get(Virus.."SOFI:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevSOFI:get(Virus.."SOFI:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevSOFI:get(Virus.."SOFI:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevSOFI:get(Virus.."SOFI:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
DevSOFI:del(Virus.."SOFI:Gif:AllRed"..v)
DevSOFI:del(Virus.."SOFI:Voice:AllRed"..v)
DevSOFI:del(Virus.."SOFI:Audio:AllRed"..v)
DevSOFI:del(Virus.."SOFI:Photo:AllRed"..v)
DevSOFI:del(Virus.."SOFI:Stecker:AllRed"..v)
DevSOFI:del(Virus.."SOFI:Video:AllRed"..v)
DevSOFI:del(Virus.."SOFI:File:AllRed"..v)
...
return false end
if text and text:match("^(.*)$") then
local VirusTeam =  DevSOFI:get(Virus..'SOFI:Help0'..msg.sender_user_id_)
...
return false end
if text and text:match("^(.*)$") then
local VirusTeam =  DevSOFI:get(Virus..'SOFI:Help01'..msg.sender_user_id_)
if VirusTeam == 'msg' then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local VirusTeam =  DevSOFI:get(Virus..'SOFI:Help21'..msg.sender_user_id_)
if VirusTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local VirusTeam =  DevSOFI:get(Virus..'SOFI:Help31'..msg.sender_user_id_)
if VirusTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local VirusTeam =  DevSOFI:get(Virus..'SOFI:Help41'..msg.sender_user_id_)
if VirusTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local VirusTeam =  DevSOFI:get(Virus..'SOFI:Help51'..msg.sender_user_id_)
if VirusTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local VirusTeam =  DevSOFI:get(Virus..'SOFI:Help61'..msg.sender_user_id_)
if VirusTeam == 'msg' then
Dev_SOFI(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
if DevSOFI:get(Virus..'Name:Bot') then
DevSOFI:set(Virus..'SOFI:NameBot',(DevSOFI:get(Virus..'Name:Bot') or 'فايروس'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevSOFI:sadd(Virus..'SOFI:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevSOFI:sadd(Virus..'SOFI:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevSOFI:sadd(Virus..'SOFI:Groups',Groups[i]) 
if DevSOFI:get(Virus.."Private:Group:Link"..Groups[i]) then
DevSOFI:set(Virus.."SOFI:Groups:Links"..Groups[i],DevSOFI:get(Virus.."Private:Group:Link"..Groups[i]))
end
if DevSOFI:get(Virus.."Get:Welcome:Group"..Groups[i]) then
DevSOFI:set(Virus..'SOFI:Groups:Welcomes'..Groups[i],DevSOFI:get(Virus.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevSOFI:smembers(Virus..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevSOFI:sadd(Virus.."SOFI:Constructor:"..Groups[i], v)
end
local list3 = DevSOFI:smembers(Virus..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevSOFI:sadd(Virus.."SOFI:BasicConstructor:"..Groups[i], v)
end
local list4 = DevSOFI:smembers(Virus..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevSOFI:sadd(Virus.."SOFI:Managers:"..Groups[i], v)
end
local list5 = DevSOFI:smembers(Virus..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevSOFI:sadd(Virus.."SOFI:Admins:"..Groups[i], v)
end
local list6 = DevSOFI:smembers(Virus..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevSOFI:sadd(Virus.."SOFI:VipMem:"..Groups[i], v)
end
DevSOFI:set(Virus.."SOFI:Lock:Bots"..Groups[i],"del") DevSOFI:hset(Virus.."SOFI:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/OOO0OOQ&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Virus     --
...
DevSOFI:incr(Virus..'SOFI:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevSOFI:get(Virus..'SOFI:Lock:EditMsgs'..msg.chat_id_) and not Text and not SOFIConstructor(result) then
...
local GetMsgPin = DevSOFI:get(Virus..'SOFI:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevSOFI:del(Virus..'SOFI:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevSOFI:del(Virus..'SOFI:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevSOFI:srem(Virus..'SOFI:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevSOFI:srem(Virus..'SOFI:Groups',v)  
end
...
DevSOFI:sadd(Virus..'SOFI:Groups',v)  
end end,nil) end
end
--     Source Virus     --
end 
